...
public class SessaoTest {
	...
	@Test
	public void oLugarA1EstaOcupadoEOsLugaresA2EA3Disponiveis() {
		...
		Set<Ingresso> igressos = Stream.of(ingresso).collect(Collectors.toSet());
		
		sessao.setIngressos(igressos);
